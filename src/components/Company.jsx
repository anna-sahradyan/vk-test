        ...
        <div className='item__inner'>
          ...
          <div className='item'>
            ...
            <p className={'item__text'}>
              Города присутствия: Санкт-Петербург и Москва
            </p>
          </div>
          <div className='item'>
            <div className='square__item'>
            ...
            {selectedEmployee === index && (
              <div className='expanded_card'>
                <div className='card'>
                  <p className={'card_text'}>
                    <span>
                      <img src={employees[selectedEmployee].imgSrc} alt='vk' />
                    </span>
                    {employees[selectedEmployee].title}
                  </p>
                  <p className={'card_text'}>
                    <span>
                      <img src='/img/price.svg' alt='' />
                    </span>
                    {employees[selectedEmployee].price}
                  </p>
                  <button
                    className={'close_btn'}
                  ...
                  <div className='employees_box'>
                    ...
                    <section className='list expectation'>
                      <ul>
                        ...
                        {employees[selectedEmployee].expectations.map(
                          (expectation, i) => (
                            <li key={i} className={'list_item'}>
                              {expectation}
                            </li>
