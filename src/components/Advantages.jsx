      ...
      <div className={'advantages__inner'}>
        ...
        <div className='advantages__menu'>
          <ul className='advantages_list'>
            ...
            <hr />
            <li className='advantages_li'>
              <span>Популярность бренда в сети</span>
              <button className={'adv_btn'}>
                <img src='/img/more.svg' alt='' />
              </button>
            </li>
            <hr />
            <li className='advantages_li'>
              <span>Передовое рабочее место</span>
              <button className={'adv_btn'}>
                <img src='/img/more.svg' alt='' />
              </button>
            </li>
            <hr />
            <li className='advantages_li'>
              <span>Свои автоматизированные системы обучения</span>
              <button className={'adv_btn'}>
                <img src='/img/more.svg' alt='' />
              </button>
            </li>
            <hr />
            <li className='advantages_li'>
              <span>Сотрудничество с ведущими Компаниями рынка</span>
              <button className={'adv_btn'}>
                <img src='/img/more.svg' alt='' />
              </button>
            </li>
