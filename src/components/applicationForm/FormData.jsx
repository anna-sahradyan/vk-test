        ...
        <div className={'wrapper'}>
            <div className="form__inner">
                <div className="form__header">
                    <span className="img_close" onClick={onClose}><img src="/img/close-form.svg" alt="close"/></span>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="select_part">
                            ...
                            <div className="text__part">
                                <p>Есть резюме в формате .pdf или .doc?
                                </p>
                        ...
                        <div className="upload__file">
                            ...
                            <button className={"upload_btn"} onClick={handleClick}>Загрузить файл</button>
                        </div>
                            <div className="text__agree">
                                <div className="check_box">
                                    <input type="checkbox" defaultChecked={false} />
                                    <span>Я прочитал(а), ознакомился(лась) и согласен(на) с Политикой конфиденциальности, Согласием на обработку персональных данных физическим лицом. Я осознаю, что даю Согласие на обработку персональных данных для использования предоставляемых возможностей Веб-сервиса.</span>
                                </div>
